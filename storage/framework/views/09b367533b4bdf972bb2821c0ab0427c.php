...
<?php $__env->startSection('title', 'Manajemen Jenis Iuran'); ?>
...
<div class="max-w-[1400px] mx-auto w-full flex flex-col gap-6 pb-10" x-data="{ editMode: false, editId: null, editName: '', editType: 'Kas Rutin', editAmount: '', editDate: '', editDesc: '', editUrl: '' }">
    ...
    <?php if(session('error')): ?>
        <div class="bg-red-50 border border-red-200 text-red-600 px-4 py-3 rounded-xl text-sm font-medium shadow-sm"><?php echo e(session('error')); ?></div>
    <?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="bg-white rounded-[30px] p-6 shadow-sm border border-slate-100 lg:sticky lg:top-6">
            ...
            <form :action="editMode ? editUrl : '<?php echo e(route('superadmin.finance.dues.store')); ?>'" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                ...
                <div x-show="!editMode">
                    ...
                    <select name="period_id" class="w-full bg-[#F4F7FE] border-none text-sm font-medium text-slate-700 rounded-xl px-4 py-2.5 focus:ring-2 focus:ring-emerald-500">
                        <?php $__currentLoopData = $periods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $period): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($period->id); ?>"><?php echo e($period->name); ?></option>
        ...
        <div class="lg:col-span-2 bg-white rounded-[30px] shadow-sm border border-slate-100 overflow-hidden">
            <div class="p-5 border-b border-slate-100 flex justify-between items-center bg-[#F4F7FE]/50">
                ...
                <span class="text-xs font-bold text-slate-400">Total: <?php echo e($dues->total()); ?> Tagihan</span>
            </div>
                ...
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-sm text-slate-700 divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-bold text-slate-800 text-sm mb-1"><?php echo e($due->name); ?></div>
                                <div class="flex items-center gap-2">
                                    <span class="bg-indigo-50 text-[#5442F5] text-[10px] font-bold px-2 py-0.5 rounded"><?php echo e($due->type); ?></span>
                                    <span class="text-xs font-bold text-emerald-600">Rp <?php echo e(number_format($due->amount, 0, ',', '.')); ?>/org</span>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4">
                                ...
                                ?>
                                <div class="font-bold <?php echo e($isLate ? 'text-red-500' : 'text-slate-600'); ?>">
                                    <?php echo e($due->due_date->format('d M Y')); ?>
                            ...
                            <td class="px-6 py-4">
                                <div class="font-bold text-slate-800 text-sm">Rp <?php echo e(number_format($due->total_collected ?? 0, 0, ',', '.')); ?></div>
                                <div class="text-[11px] font-medium text-slate-400 mt-0.5"><?php echo e($due->lunas_count); ?> anggota lunas</div>
                            </td>

                            <!-- Kolom 4: Aksi -->
                            <td class="px-6 py-4 flex justify-end gap-2">
                                <!-- Tombol AlpineJS Edit -->
                                <button type="button" @click="editMode = true; editId = <?php echo e($due->id); ?>; editName = '<?php echo e(addslashes($due->name)); ?>'; editType = '<?php echo e($due->type); ?>'; editAmount = '<?php echo e($due->amount); ?>'; editDate = '<?php echo e($due->due_date->format('Y-m-d')); ?>'; editDesc = '<?php echo e(addslashes($due->description)); ?>'; editUrl = '<?php echo e(route('superadmin.finance.dues.update', $due->id)); ?>'" class="p-2 text-blue-500 hover:bg-blue-50 rounded-lg transition-colors" title="Edit Tagihan">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                </button>
                                
                                <form action="<?php echo e(route('superadmin.finance.dues.destroy', $due->id)); ?>" method="POST" onsubmit="return confirm('Peringatan: Menghapus tagihan ini akan menghapus seluruh data SETORAN dan BUKTI BAYAR anggota untuk tagihan ini. Lanjutkan?');">
            ...
            <div class="p-4 border-t border-slate-100"><?php echo e($dues->links()); ?></div>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sim-hima\resources\views/superadmin/dues/index.blade.php ENDPATH**/ ?>