    ...
    <section id="tentang" class="bg-white rounded-t-[40px] lg:rounded-t-[64px] -mt-8 relative z-20 pt-16 pb-16 px-4 sm:px-6 lg:px-12">
        <div class="max-w-[1200px] mx-auto">
            ...
            <div>
                ...
                <?php if($pengurusInti->isEmpty() && $divisiBesertaAnggota->isEmpty()): ?>
                ...
                <?php else: ?>
                    ...
                    <?php if($pengurusInti->isNotEmpty()): ?>
                        ...
                        <div class="mb-14">
                            ...
                            <div class="flex flex-wrap justify-center gap-6 lg:gap-10">
                                <?php $__currentLoopData = $pengurusInti; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bph): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                        // Olah Foto
                                    ...
                                    <div x-data="{ openModal: false }" class="group flex flex-col items-center text-center w-48">
                                        ...
                                        <div @click="openModal = true" class="relative w-full aspect-[4/5] rounded-[2rem] overflow-hidden shadow-md hover:shadow-xl bg-indigo-50 mb-4 cursor-pointer border-4 border-white transition-all">
                                            <img src="<?php echo e($fotoUrl); ?>" alt="<?php echo e($bph->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                                        ...
                                        <h4 class="font-extrabold text-slate-800 text-sm mb-1 leading-snug line-clamp-2"><?php echo e($bph->name); ?></h4>
                                        <span class="text-[11px] font-bold text-[#5442F5] mt-auto uppercase tracking-wider text-center">
                                            <?php echo e($bph->jabatan ?? $bph->position ?? $bph->getRoleNames()->first() ?? 'BPH'); ?>
                                                ...
                                                <div x-show="openModal" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-8 scale-95" x-transition:enter-end="opacity-100 translate-y-0 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 scale-100" x-transition:leave-end="opacity-0 translate-y-8 scale-95" class="relative w-full max-w-sm bg-white rounded-[32px] shadow-2xl overflow-hidden z-10 flex flex-col">
                                                    ...
                                                    <div class="px-8 pb-8 pt-0 relative flex flex-col items-center text-center">
                                                        <div class="w-24 h-24 -mt-12 mb-3 rounded-full border-4 border-white shadow-lg bg-white overflow-hidden relative z-10">
                                                            <img src="<?php echo e($fotoUrl); ?>" alt="<?php echo e($bph->name); ?>" class="w-full h-full object-cover">
                                                        </div>
                                                        <h2 class="text-xl font-black text-slate-800"><?php echo e($bph->name); ?></h2>
                                                        <p class="text-sm font-bold text-[#5442F5] mb-2"><?php echo e($nimData); ?></p>
                                                        ...
                                                        <div class="w-full text-left space-y-4 border-t border-slate-100 pt-5">
                                                            <div>
                                                                ...
                                                                <p class="text-sm font-bold text-slate-700"><?php echo e($contact); ?></p>
                                                            </div>
                                                            <div>
                                                                ...
                                                                <div class="flex flex-wrap gap-1.5">
                                                                    <?php $__empty_1 = true; $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                        <span class="bg-indigo-50 text-[#5442F5] text-[10px] font-bold px-2.5 py-1 rounded-md"><?php echo e($skill); ?></span>
                    ...
                    <div class="space-y-12">
                        <?php $__currentLoopData = $divisiBesertaAnggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <div class="flex items-center gap-3 mb-6">
                                    <h3 class="text-lg lg:text-xl font-extrabold text-slate-800 uppercase tracking-tight">Divisi <?php echo e($divisi->singkatan); ?></h3>
                                    <div class="h-px bg-slate-200 flex-grow"></div>
                                </div>

                                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 lg:gap-5">
                                    <?php $__currentLoopData = $divisi->anggota; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pengurus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <div x-data="{ openModal: false }" class="group flex flex-col items-center text-center">
                                            ...
                                            <div @click="openModal = true" class="relative w-full aspect-[4/5] rounded-3xl overflow-hidden shadow-sm hover:shadow-lg bg-slate-50 mb-3 cursor-pointer border-2 border-white transition-all">
                                                <img src="<?php echo e($fotoUrl); ?>" alt="<?php echo e($pengurus->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                                            ...
                                            <h4 class="font-bold text-slate-800 text-[13px] mb-1 leading-snug line-clamp-2"><?php echo e($pengurus->name); ?></h4>
                                            <span class="px-2 py-1 bg-slate-50 text-slate-500 text-[9px] font-bold rounded-md uppercase tracking-wider mt-auto">
                                                <?php echo e($pengurus->getRoleNames()->first() ?? 'Anggota'); ?>
                                            ...
                                            <template x-teleport="body">
                                                <div x-show="openModal" class="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6" style="display: none;">
                                                    ...
                                                    <div x-show="openModal" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-y-8 scale-95" x-transition:enter-end="opacity-100 translate-y-0 scale-100" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="opacity-100 translate-y-0 scale-100" x-transition:leave-end="opacity-0 translate-y-8 scale-95" class="relative w-full max-w-sm bg-white rounded-[32px] shadow-2xl overflow-hidden z-10 flex flex-col text-center">
                                                        ...
                                                        <div class="px-8 pb-8 pt-0 relative flex flex-col items-center text-center">
                                                            <div class="w-24 h-24 -mt-12 mb-3 rounded-full border-4 border-white shadow-lg bg-white overflow-hidden relative z-10">
                                                                <img src="<?php echo e($fotoUrl); ?>" alt="<?php echo e($pengurus->name); ?>" class="w-full h-full object-cover">
                                                            </div>
                                                            <h2 class="text-xl font-black text-slate-800"><?php echo e($pengurus->name); ?></h2>
                                                            <p class="text-sm font-bold text-slate-500 mb-2"><?php echo e($nimData); ?></p>
                                                            <span class="bg-indigo-50 text-[#5442F5] text-[10px] font-extrabold px-3 py-1 rounded-full mb-6 uppercase tracking-wider">Divisi <?php echo e($divisi->singkatan); ?></span>
                                                            <div class="w-full text-left space-y-4 border-t border-slate-100 pt-5">
                                                                <div>
                                                                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Kontak Darurat</p>
                                                                    <p class="text-sm font-bold text-slate-700"><?php echo e($contact); ?></p>
                ...
                <div class="bg-white rounded-[32px] p-4 shadow-sm hover:shadow-xl border border-slate-100 hover:-translate-y-2 transition-all duration-300 group flex flex-col h-full animate-fade-in-up">
                    ...
                    <div class="px-2 flex-grow flex flex-col">
                        ...
                        <div class="flex items-center gap-2 mb-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider">
                            <span class="text-slate-300">✍️</span> <?php echo e($news->penulis ?? $news->author ?? 'Tim Kominfo'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div class="lg:col-span-1">
                    <a href="#" class="flex items-center gap-3 mb-6">
                        <img src="<?php echo e(asset('logo.png')); ?>" onerror="this.outerHTML='<div class=\'w-10 h-10 bg-gradient-to-br from-[#5442F5] to-[#8066FF] rounded-xl flex items-center justify-center text-white font-black text-xl shadow-lg\'>H</div>'" alt="Logo HIMA" class="w-10 h-10 object-contain bg-white rounded-xl p-1">
...
</html><?php /**PATH C:\xampp\htdocs\sim-hima\resources\views/welcome.blade.php ENDPATH**/ ?>