            ...
            <div class="w-full max-w-md">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5" novalidate>
                    ...
                    <div>
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus placeholder="Contoh: Muhammad Ilham" 
                    ...
                    <div>
                        ...
                        <input id="nim" type="text" name="nim" value="{{ old('nim') }}" required placeholder="Contoh: 2024xxxx" 
                            class="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 text-slate-800 text-sm font-medium rounded-2xl focus:ring-4 focus:ring-[#5442F5]/10 focus:border-[#5442F5] focus:bg-white transition-all outline-none">
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="{{ old('email') }}" required placeholder="Gunakan email aktif" 
                            class="w-full px-5 py-3.5 bg-slate-50 border border-slate-200 text-slate-800 text-sm font-medium rounded-2xl focus:ring-4 focus:ring-[#5442F5]/10 focus:border-[#5442F5] focus:bg-white transition-all outline-none">
                ...
                <p class="mt-8 text-center text-sm font-medium text-slate-500">
                    ...
                    <a href="{{ route('login') }}" class="font-bold text-[#5442F5] hover:underline">Masuk di sini</a>
                </p>
