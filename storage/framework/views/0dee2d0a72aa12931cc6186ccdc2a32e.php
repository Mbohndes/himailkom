    ...
    <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div class="lg:col-span-1">
                <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm font-medium text-slate-400">
                    <li><a href="<?php echo e(url('/#beranda')); ?>" class="hover:text-[#818CF8] transition-colors flex items-center gap-2"><span class="text-[#5442F5]">▸</span> Beranda</a></li>
                    <li><a href="<?php echo e(url('/#tentang')); ?>" class="hover:text-[#818CF8] transition-colors flex items-center gap-2"><span class="text-[#5442F5]">▸</span> Tentang</a></li>
                    <li><a href="<?php echo e(url('/#berita')); ?>" class="hover:text-[#818CF8] transition-colors flex items-center gap-2"><span class="text-[#5442F5]">▸</span> Berita</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="border-t border-slate-800 pt-8 text-center md:text-left text-sm font-medium text-slate-500">
            <p>© <?php echo e(date('Y')); ?> Himpunan Mahasiswa Ilmu Komputer. All Rights Reserved.</p>
        </div>
    </div>
</footer><?php /**PATH C:\xampp\htdocs\sim-hima\resources\views/layouts/footer.blade.php ENDPATH**/ ?>