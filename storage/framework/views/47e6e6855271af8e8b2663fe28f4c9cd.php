...
<div class="max-w-[1400px] mx-auto w-full flex flex-col gap-6 pb-10">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="<?php echo e(route('superadmin.news.create')); ?>" class="px-5 py-2.5 bg-[#5442F5] hover:bg-[#4331e5] text-white rounded-xl font-semibold text-sm shadow-md transition-colors flex items-center gap-2">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-4">
                                <div class="w-16 h-12 rounded-lg bg-slate-200 flex-shrink-0 bg-cover bg-center" style="background-image: url('<?php echo e($news->thumbnail ? asset('storage/'.$news->thumbnail) : 'https://placehold.co/150x100?text=News'); ?>')"></div>
                                <div>
                                    <div class="font-bold text-slate-800 text-sm mb-1 line-clamp-1"><?php echo e($news->title); ?></div>
                        ...
                        <td class="px-6 py-4">
                            <div class="font-bold text-slate-700"><?php echo e($news->author->name ?? '-'); ?></div>
                            <div class="text-xs text-slate-400 mt-0.5 font-medium"><?php echo e($news->category->name ?? 'Uncategorized'); ?></div>
                        </td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-1 text-slate-500 font-bold">
                                ...
                                <?php echo e(number_format($news->views_count ?? 0, 0, ',', '.')); ?>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <?php elseif($news->status === 'Scheduled'): ?>
                            ...
                            <div class="text-[11px] text-slate-400 mt-1 font-medium">
                                <?php echo e($news->published_at ? \Carbon\Carbon::parse($news->published_at)->format('d M Y, H:i') : 'Belum rilis'); ?>
                        ...
                        <td class="px-6 py-4 flex justify-end gap-2">
                            <a href="<?php echo e(route('superadmin.news.show', $news->slug)); ?>" class="p-2 text-blue-500 hover:bg-blue-50 rounded-lg transition-colors" title="Lihat Artikel">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path></svg>
                            </a>
                            
                            <a href="<?php echo e(route('superadmin.news.edit', $news->id)); ?>" class="p-2 text-[#5442F5] hover:bg-indigo-50 rounded-lg transition-colors" title="Edit Berita">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                            </a>

                            <form action="<?php echo e(route('superadmin.news.destroy', $news->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus berita ini secara permanen?');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sim-hima\resources\views/superadmin/news/index.blade.php ENDPATH**/ ?>