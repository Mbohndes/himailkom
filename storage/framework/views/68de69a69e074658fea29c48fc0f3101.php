...
<?php $__env->startSection('title', 'Data Program Kerja'); ?>
...
<div class="max-w-[1400px] mx-auto w-full flex flex-col gap-6 pb-10">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="<?php echo e(route('superadmin.prokers.create')); ?>" class="px-5 py-2.5 bg-[#5442F5] hover:bg-[#4331e5] text-white rounded-xl font-semibold text-sm shadow-md shadow-indigo-200 transition-colors flex items-center gap-2">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-sm text-slate-700 divide-y divide-slate-100">
                    <?php $__empty_1 = true; $__currentLoopData = $prokers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proker): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-slate-50 transition-colors">
                        
                        <td class="px-6 py-4">
                            <div class="font-bold text-slate-800 text-base mb-0.5"><?php echo e($proker->name); ?></div>
                            <div class="text-xs font-semibold text-slate-400 bg-slate-100 inline-block px-2 py-0.5 rounded-md">
                                <?php echo e($proker->program_code); ?>

                            </div>
                        </td>

                        <td class="px-6 py-4">
                            <div class="font-bold text-slate-700"><?php echo e($proker->division->name ?? '-'); ?></div>
                            <div class="text-xs text-slate-500 mt-0.5 flex items-center gap-1">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                                PIC: <?php echo e($proker->pic->name ?? '-'); ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="font-medium text-slate-700">
                                <?php echo e(\Carbon\Carbon::parse($proker->start_date)->format('d M Y')); ?>

                            </div>
                            <div class="text-xs text-slate-400 mt-0.5">
                                s.d <?php echo e(\Carbon\Carbon::parse($proker->end_date)->format('d M Y')); ?>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <?php elseif($proker->status === 'Dibatalkan'): ?>
                        ...
                        <td class="px-6 py-4 flex items-center justify-end gap-2">
                            ...
                            <a href="<?php echo e(route('superadmin.prokers.committee', $proker->id)); ?>" class="p-2 text-emerald-500 hover:bg-emerald-50 rounded-lg transition-colors" title="Manajemen Panitia & Tugas">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                            </a>

                            <!-- Tombol Edit Proker -->
                            <a href="<?php echo e(route('superadmin.prokers.edit', $proker->id)); ?>" class="p-2 text-[#5442F5] hover:bg-indigo-50 rounded-lg transition-colors" title="Edit Proker">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                            </a>

                            <!-- Tombol Hapus Proker -->
                            <form action="<?php echo e(route('superadmin.prokers.destroy', $proker->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus Program Kerja ini? Semua data terkait (Anggaran, LPJ) yang terhubung mungkin akan terdampak.');">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sim-hima\resources\views/superadmin/prokers/index.blade.php ENDPATH**/ ?>