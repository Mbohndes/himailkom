...
<div class="max-w-[1400px] mx-auto w-full flex flex-col gap-6 pb-10">
    ...
    <div class="flex items-center gap-4 mb-2">
        <a href="<?php echo e(route('superadmin.news.index')); ?>" class="w-10 h-10 bg-white rounded-full flex items-center justify-center text-slate-500 shadow-sm hover:bg-slate-50">
    ...
    <!-- Form Pembungkus -->
    <form action="<?php echo e(route('superadmin.news.store')); ?>" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.superadmin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sim-hima\resources\views/superadmin/news/create.blade.php ENDPATH**/ ?>