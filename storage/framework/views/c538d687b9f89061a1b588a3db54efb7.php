        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-20 bg-white">
            <div class="w-full max-w-md">
                ...
                <div class="text-center lg:text-left mb-10">
                    <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center gap-3 group mb-8">
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus placeholder="contoh@kampus.ac.id" 
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-bold text-[#5442F5] hover:underline">Lupa Sandi?</a>
                            <?php endif; ?>
                        </div>
                ...
                <p class="mt-8 text-center text-sm font-medium text-slate-500">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="font-bold text-[#5442F5] hover:underline">Daftar di sini</a>
                </p>
...
</html><?php /**PATH C:\xampp\htdocs\sim-hima\resources\views/auth/login.blade.php ENDPATH**/ ?>