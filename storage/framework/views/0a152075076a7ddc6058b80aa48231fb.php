...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - HIMA ILMU KOMPUTER</title>
...
<body class="text-slate-800 antialiased" x-data="{ sidebarOpen: false }">
        ...
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path></svg>
                ...
                <nav class="space-y-6 pb-20"> 
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="<?php echo e(route('superadmin.dashboard')); ?>" @click="if(window.innerWidth < 1024) sidebarOpen = false" class="flex items-center gap-3 px-4 py-2.5 <?php echo e(request()->routeIs('superadmin.dashboard') ? 'bg-[#5442F5] text-white shadow-md shadow-indigo-200' : 'text-slate-500 hover:bg-indigo-50 hover:text-[#5442F5]'); ?> rounded-2xl font-semibold text-sm transition-all">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            <a href="<?php echo e(route('superadmin.masterdata.periods.index')); ?>" class="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-slate-800 rounded-2xl font-medium text-sm transition-all">
                                <span class="w-1.5 h-1.5 rounded-full bg-slate-400"></span> Periode Kepengurusan
                            </a>
                            <a href="<?php echo e(route('superadmin.divisions.index')); ?>" class="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-slate-800 rounded-2xl font-medium text-sm transition-all">
                                  <span class="w-1.5 h-1.5 rounded-full bg-slate-400"></span> Divisi
                            </a>
                            <a href="<?php echo e(route('superadmin.positions.index')); ?>" class="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-slate-800 rounded-2xl font-medium text-sm transition-all">
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Super Admin|BPH|Kepala Divisi')): ?>
                    <div class="mt-4">
                        <p class="px-4 text-[11px] font-bold text-slate-400 tracking-wider mb-2">KEANGGOTAAN</p>
                        <div class="space-y-1" x-data="{ openMember: <?php echo e(request()->routeIs('superadmin.membership.*') ? 'true' : 'false'); ?> }">
                            ...
                            <div x-show="openMember" x-collapse class="pl-11 pr-4 py-1 space-y-1">
                                <?php if (\Illuminate\Support\Facades\Blade::check('role', 'Super Admin')): ?>
                                    <a href="<?php echo e(route('superadmin.membership.applications.index')); ?>" class="block py-1.5 text-xs font-bold text-[#5442F5] transition-colors">Pendaftaran Mahasiswa</a>
                                    <a href="<?php echo e(route('superadmin.membership.users.index')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Manajemen Pengguna</a>
                                <?php endif; ?>
                                
                                <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Super Admin|BPH|Kepala Divisi')): ?>
                                    <a href="<?php echo e(route('superadmin.membership.data.index')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Data Anggota</a>
                                <?php endif; ?>
                                
                                <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Super Admin|BPH')): ?>
                                    <a href="<?php echo e(route('superadmin.membership.alumni.index')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Data Alumni</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="space-y-1" x-data="{ openReport: <?php echo e(request()->routeIs('superadmin.reports.*') ? 'true' : 'false'); ?> }">
                            ...
                            <div x-show="openReport" x-collapse class="pl-11 pr-4 py-1 space-y-1">
                                <a href="<?php echo e(route('superadmin.reports.index')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Dashboard Laporan</a>
                                <a href="<?php echo e(route('superadmin.reports.members')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Laporan Anggota</a>
                                <a href="<?php echo e(route('superadmin.reports.programs')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Laporan Program Kerja</a>
                                <a href="<?php echo e(route('superadmin.reports.finance')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Laporan Keuangan</a>
                                <a href="<?php echo e(route('superadmin.reports.activity')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Laporan Keaktifan</a>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="space-y-1" x-data="{ openProker: <?php echo e(request()->routeIs('superadmin.prokers.*') ? 'true' : 'false'); ?> }">
                            ...
                            <div x-show="openProker" x-collapse class="pl-11 pr-4 py-1 space-y-1">
                                <a href="<?php echo e(route('superadmin.prokers.dashboard')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Dashboard Proker</a>
                                <a href="<?php echo e(route('superadmin.prokers.index')); ?>" class="block py-1.5 text-xs font-medium <?php echo e(request()->routeIs('superadmin.prokers.index') ? 'text-[#5442F5] font-bold' : 'text-slate-500'); ?> hover:text-[#5442F5] transition-colors">Data Proker</a>
                            </div>
                            
                            <a href="<?php echo e(route('superadmin.agendas.index')); ?>" class="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-[#5442F5] hover:bg-indigo-50/50 rounded-2xl font-medium text-sm transition-all">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="space-y-1" x-data="{ openNews: <?php echo e(request()->routeIs('superadmin.news.*') ? 'true' : 'false'); ?> }">
                            ...
                            <div x-show="openNews" x-collapse class="pl-11 pr-4 py-1 space-y-1">
                                <a href="<?php echo e(route('superadmin.news.dashboard')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Dashboard Berita</a>
                                <a href="<?php echo e(route('superadmin.news.index')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Semua Berita</a>
                                <a href="<?php echo e(route('superadmin.news.categories.index')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Kategori</a>
                                <a href="<?php echo e(route('superadmin.news.tags.index')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Tag</a>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>

                    <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Super Admin|BPH|Kepala Divisi|Anggota')): ?>
                    <div class="mt-4">
                        <p class="px-4 text-[11px] font-bold text-slate-400 tracking-wider mb-2">KEUANGAN & DOKUMENTASI</p>
                        
                        <?php if (! \Illuminate\Support\Facades\Blade::check('role', 'Kepala Divisi')): ?>
                        <div class="space-y-1" x-data="{ openFinance: <?php echo e(request()->routeIs('superadmin.finance.*') ? 'true' : 'false'); ?> }">
                            ...
                            <div x-show="openFinance" x-collapse class="pl-11 pr-4 py-1 space-y-2">
                                <a href="<?php echo e(route('superadmin.finance.dashboard')); ?>" class="block py-1 text-xs font-bold text-slate-500 hover:text-[#5442F5] transition-colors">Dashboard Keuangan</a>
                                ...
                                <div x-data="{ openTransaksi: false }">
                                    ...
                                    <div x-show="openTransaksi" x-collapse class="pl-3 mt-1 space-y-1 border-l border-slate-200">
                                        <a href="<?php echo e(route('superadmin.finance.incomes.index')); ?>" class="block py-1 text-xs font-medium text-slate-500 hover:text-[#5442F5]">Pemasukan</a>
                                        <a href="<?php echo e(route('superadmin.finance.expenses.index')); ?>" class="block py-1 text-xs font-medium text-slate-500 hover:text-[#5442F5]">Pengeluaran</a>
                                    </div>
                                </div>
                                <?php endif; ?>
                                ...
                                <div x-data="{ openIuran: true }">
                                    ...
                                    <div x-show="openIuran" x-collapse class="pl-3 mt-1 space-y-1 border-l border-slate-200">
                                        <?php if (! \Illuminate\Support\Facades\Blade::check('role', 'Anggota')): ?>
                                            <a href="<?php echo e(route('superadmin.finance.dues.index')); ?>" class="block py-1 text-xs font-medium text-slate-500 hover:text-[#5442F5]">Master Iuran</a>
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('superadmin.finance.payments')); ?>" class="block py-1 text-xs font-medium text-slate-500 hover:text-[#5442F5]"><?php echo e(auth()->user()->hasRole('Anggota') ? 'Tagihan Saya' : 'Pembayaran Iuran'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <a href="<?php echo e(route('superadmin.archives.index')); ?>" class="mt-1 w-full flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-[#5442F5] hover:bg-indigo-50/50 rounded-2xl font-medium text-sm transition-all">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"></path></svg>
                            Arsip Digital
                        </a>

                        <div class="space-y-1 mt-1" x-data="{ openGaleri: <?php echo e(request()->routeIs('superadmin.gallery.*') ? 'true' : 'false'); ?> }">
                            ...
                            <div x-show="openGaleri" x-collapse class="pl-11 pr-4 py-1 space-y-1">
                                <a href="<?php echo e(route('superadmin.gallery.index')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Semua Album</a>
                                <?php if (! \Illuminate\Support\Facades\Blade::check('role', 'Anggota')): ?>
                                    <a href="<?php echo e(route('superadmin.gallery.create')); ?>" class="block py-1.5 text-xs font-medium text-slate-500 hover:text-[#5442F5] transition-colors">Tambah Album</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="<?php echo e(route('superadmin.activity_logs.index')); ?>" class="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-slate-800 rounded-2xl font-medium text-sm transition-all">
                    ...
                    <div class="border-t border-slate-100 pt-4 mt-6">
                        <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center gap-3 px-4 py-2 text-slate-500 hover:text-[#5442F5] rounded-2xl font-medium text-sm transition-all">
            ...
            <a href="<?php echo e(route('panduan.sistem')); ?>" class="group flex items-center gap-3 px-4 py-3.5 bg-indigo-50/50 hover:bg-[#5442F5] text-[#5442F5] hover:text-white text-sm font-bold rounded-2xl transition-all duration-300 shadow-sm mt-4">
    ...
    <header class="flex items-center justify-between px-4 py-3 bg-white shadow-sm lg:hidden z-30 border-b border-slate-100">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('profile.edit')); ?>" class="w-9 h-9 rounded-full bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-500 shadow-sm">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
            </a>
...
<footer class="mt-auto py-6 px-4 md:px-8 text-center border-t border-slate-200/60 bg-white/50 backdrop-blur-sm">
                <p class="text-sm text-slate-500 font-medium">
                    &copy; <?php echo e(date('Y')); ?> Sistem Informasi HIMA ILMU KOMPUTER. <br class="sm:hidden">
                    Dibuat <span class="text-red-500 animate-pulse"></span> oleh <span class="font-extrabold text-[#5442F5]">Riski Kurniawan</span>.
                </p>
            </footer>
</html><?php /**PATH C:\xampp\htdocs\sim-hima\resources\views/layouts/superadmin.blade.php ENDPATH**/ ?>